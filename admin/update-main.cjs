...
// Add application rendering functions
const appsFunctions = `
  ...
  try {
    ...
    apps.forEach((app: any) => {
      ...
      tr.innerHTML = \`
        ...
        <td><span class="status-badge" style="background:orange;color:white;">待審核</span></td>
        <td>
...
code = code.replace(`// Init`, appsFunctions + `\n// Init`);

// Auth switch logic
const authSwitchCode = `
...
code = code.replace(`  // Login\n  document.getElementById('login-form')`, authSwitchCode + `\n  // Login\n  document.getElementById('login-form')`);
