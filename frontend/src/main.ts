...
function setupEventListeners() {
  ...
  postForm.addEventListener('submit', async (e) => {
    ...
    const profanityWords = ['機掰', '傻逼', '智障', '尼哥', '婊子', '狗娘養', '草泥馬', '草你媽', 'fuck', 'shit', 'damn', 'bitch', 'asshole', 'dick', 'pussy', 'wtf', 'stfu', '死全家', '低能', '腦殘', '弱智', '外勞', '番仔', '死玻璃', '台女', '母豬', '傻屌', '憨Ｂ', '憨B', '憨兒', '破麻', '綠茶婊', '廢物', '垃圾', '畜生', '敗類', '賤人', '死媽', '死屁孩', '智缺', 'slut', 'whore', 'cunt', 'faggot', 'nigger', 'nigga', 'retard', 'kys', 'motherfucker', 'mf', 'douchebag', '幹', '幹你娘', '幹您娘', '靠北', '靠杯', '靠夭', '靠腰', '媽的', '他媽的', '操', '操你媽', '操您媽'];
    ...
    submitPostBtn.innerHTML = '<span class="send-text">發送中...</span>';
    ...
    try {
      ...
      submitPostBtn.innerHTML = '<span class="send-text">送出</span><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="22" y1="2" x2="11" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg>';
    }
  });
